...
hC = plot(x_coor(1:Lx/2)+1, ns_extraplt(1:Lx/2), 's', 'DisplayName', ['$n_s, D = ', num2str(D),'$'],'MarkerSize', 6); hold on;
...
h_fit_C = plot(x, fitted_curve, '-.'); hold on;
