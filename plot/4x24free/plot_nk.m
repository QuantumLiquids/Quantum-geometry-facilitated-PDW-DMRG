% Load nk data
nkD2000 = jsondecode(fileread('nkD15000.json'));
...
plot(kx_set, nkD2000(:,2,1), '--', 'DisplayName', 'k_y=\pi/2, k_z=0');
plot(kx_set, nkD2000(:,2,2), '-.', 'DisplayName', 'k_y=\pi/2, k_z=\pi');
plot(kx_set, nkD2000(:,3,1), '--', 'DisplayName', 'k_y=\pi, k_z=0');
plot(kx_set, nkD2000(:,3,2), '-.', 'DisplayName', 'k_y=\pi, k_z=\pi');
plot(kx_set, nkD2000(:,4,1), '--', 'DisplayName', 'k_y=3\pi/2, k_z=0');
plot(kx_set, nkD2000(:,4,2), '-.', 'DisplayName', 'k_y=3\pi/2, k_z=\pi');
